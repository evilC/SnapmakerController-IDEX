 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_PERIOD        1080 // Seconds
 ...
 */
#define E0_AUTO_FAN_PIN 8  //PA8
#define E1_AUTO_FAN_PIN 40  // PC8
...
#define CHAMBER_AUTO_FAN_PIN 38  // PC6
...
#define CASE_LIGHT_ENABLE
  ...
  #define CASE_LIGHT_DEFAULT_BRIGHTNESS 150   // Set default power-up brightness (0-255, requires PWM pin)
...
#define DUAL_X_CARRIAGE
  ...
  #define X2_MAX_POS   (X1_MAX_POS - X1_MIN_POS)       // Set this to the distance between toolheads when both heads are homed
 ...
 */
  ...
  #define E0_SLAVE_ADDRESS 4
  #define E1_SLAVE_ADDRESS 5
